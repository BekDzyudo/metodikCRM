...
export default function Amaliyot() {
    return (
                        ...
                        <div className="col-9">
                            <div className="malumot_body">
                                <div className="malumot_body-btn">
                                    ...
                                    <div className="col-2 malumot_top">
                                        <Link className="malumot_btn" to="/Professional-Talim-Muassasalari/maxsusfan">
                                            <p>Maxsus fanlar</p>
                                        </Link>
                                    </div>
                                    <div className="col-2 malumot_top">
                                        <Link className="malumot_btn active" to="/Professional-Talim-Muassasalari/amaliyot">
                                            <p>O'quv amaliyoti</p>
                                        </Link>
                                    </div>
