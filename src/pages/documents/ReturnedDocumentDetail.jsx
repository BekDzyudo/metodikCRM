...
export default function ReturnedDocumentDetail() {
    return (
        <div className='container'>
            <div className="top">
                ...
                <div className="right">
                    <Link to="/Document/ReturnedDocument"><i class="bi bi-arrow-left-short"></i>Orqaga</Link>
                </div>
            </div>
            <div className="row">
                        ...
                        <div className="col-9 bordertop">
                            <div className="document_new">
                                <div style={{ display: "flex", alignItems: "center" }}>
                                    <span className='incoming_title'>Qaytgan hujjat</span><span className='document_new-rad'><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6" fill="none">
                                        <circle cx="3" cy="3" r="3" fill="#D30000" />
                                    </svg> Rad etilgan</span>
                                </div>
