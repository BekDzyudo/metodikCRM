...
function MaterialDetail() {
  ...
  const {data} = useGetFetch(`${import.meta.env.VITE_BASE_URL}/birlashma/material-detail/${id}/`)
                      ...
                      {(props) => {
                        ...
                        return (
                          ...
                          <span ><CurrentPageLabel /> / <NumberOfPages /></span>
                            ...
                            <Zoom />
                            <ZoomIn />
                            <button style={{background:"none"}} onClick={handleDownload}><BsDownload/></button>
                          </>
                        );
                      }}
                    </Toolbar>
